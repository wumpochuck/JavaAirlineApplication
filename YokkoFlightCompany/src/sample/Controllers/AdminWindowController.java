...
public class AdminWindowController {
    ...
    @FXML
    private TableColumn<User, Integer> userColumnMoney;
    ...
    public void initSettings(){
        userColumnID.setCellValueFactory(new PropertyValueFactory<User,Integer>("userId"));
        ...
        userColumnMoney.setCellValueFactory(new PropertyValueFactory<User,Integer>("money"));
    ...
    public void onEditUserButtonClick(){
        ...
        String role = textChoiceBoxRole.getValue().toString();
        try {
            new DataBaseHandler().updateUserById(new User(chosen_user.getUserId(),login,password,name,surname,money,role));
            usersTableUpdate();
        } catch (SQLException e) { e.printStackTrace(); }
    }
